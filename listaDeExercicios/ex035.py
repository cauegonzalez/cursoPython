...
if possivel and abs(reta3 - reta2) < reta1 and reta1 < reta3 + reta2:
    possivel = True
else:
    possivel = False
        
if possivel and abs(reta1 - reta2) < reta3 and reta3 < reta1 + reta2:
    possivel = True
else:
    possivel = False

if possivel and abs(reta3 - reta1) < reta2 and reta2 < reta3 + reta1:
    possivel = True
else:
    possivel = False
